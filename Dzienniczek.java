...
class Dzienniczek {
  public static void main(String[]args) {
    ...
    System.out.println("Oto twój ma³y dzienniczek ucznia");
    System.out.println("Wybierz przedmiot aby wyœwietliæ lub dodaæ oceny");
    System.out.println("1.Matematyka");
    System.out.println("2.Polski");
    System.out.println("3.Angielski"); //wypisujemy nazwy przedmiotów
    
    int zero = 0;
    Scanner tekst = new Scanner(System.in);
    int cyfra = tekst.nextInt();
    System.out.println("Wybra³eœ numer" + cyfra);
    
    	if(cyfra==1){
    		int mr = matematyka.size();
    		System.out.println("1.Dodawanie ocen");
    		System.out.println("2.Wyœwitlanie ocen");
    		int cyfraa = tekst.nextInt();
    			if(cyfraa==1){
    				System.out.println("Podaj ocenê któr¹ chesz dodaæ do dzienniczka");
